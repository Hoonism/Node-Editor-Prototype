...
class NodeEditorWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        editMenu.addSeparator()
        editMenu.addAction(self.createAct('&Delete', 'X', 'Delete selected items', self.onEditDelete))
    ...
    def maybeSave(self):
        ...
        res = QMessageBox.warning(self, 'About to lose your work?', "The document has been modified. \n Do you want to save your changes?", QMessageBox.Save | QMessageBox.Discard | QMessageBox.Cancel)
